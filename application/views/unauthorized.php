...
<body>
    ...
    <div class="row">
        ...
        <div class="col s10 m8 l4 z-depth-3 white center-align">
            <!--Form-->
            <br>
            <img class="responsive-img" src="<?= base_url()?>image/icon_forbidden.jpg" width="200">
            <br>
            <blockquote><h5 class="grey lighten-3" style="color: #808080">Favor de Ingresar de manera legal</h5></blockquote>
            <br>
            <!--Button-->
